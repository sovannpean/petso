...
<body>
    <div class="antialiased bg-gray-50">
            ...
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                    ...
                    <a href="/" class="flex items-center justify-between mr-4">
                        ...
                        <span class="self-center text-2xl font-semibold whitespace-nowrap">PetsRescue</span>
                    </a>
                            ...
                            <a href="#"
                                ...
                                <div class="pl-3 w-full">
                                    <div class="text-gray-500 font-normal text-sm mb-1.5">
                                        ...
                                        <span
                                            class="font-medium text-primary-600">@bonnie.green</span>
                                        what do you say?
                                    </div>
                                    <div class="text-xs font-medium text-primary-600">
                                        1 hour ago
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                            <li>
                                <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">
                                    Pets
                                </a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                            <li>
                                <a href="#"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">Donation</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100">Adoption</a>
                            </li>
                            {{-- <li>
                                <a href="#"
        ...
        <main class="p-4 md:ml-64 h-auto pt-20">
            {{-- <div class="border-2 border-dashed rounded-lg border-gray-300 h-96 mb-4">
                <div class="col-md-8">
                    @yield('index')
                </div>
                <div class="col-md-8">
