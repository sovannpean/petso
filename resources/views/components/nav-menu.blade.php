<nav class="bg-white dark:bg-gray-900 w-full dark:border-gray-600">
    <div class="max-w-screen-2xl mx-auto">            
        <button id="categories" data-dropdown-toggle="dropdown" class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-lg font-medium text-center text-white bg-[#5B96A6] rounded-lg hover:bg-[#6CC1D8] focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600" type="button">
