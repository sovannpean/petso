        ...
        <form>
            <div class="flex">
                ...
                <div class="relative w-full">
                    ...
                    <button type="submit" class="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-[#5B96A6] rounded-e-lg border border-[#5B96A6] hover:bg-[#6CC1D8] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
