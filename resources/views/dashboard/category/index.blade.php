                        ...
                        @foreach ($categories as $category)
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">
                                    <a href=" {{ url('/dashboard/category/show/'. $category->id)}} " title="View Item" class="btn btn-primary btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</a>
                                </td>
                ...
                <form class="form-group" method="POST" action="{{url('/dashboard/category/create')}}" enctype="multipart/form-data">
                    ...
                    <div class="my-5 px-5">
                        <div class="flex flex-col gap-2">
                            ...
                            <input class="form-control py-2.5 px-2 rounded-lg border" type="text" name="name" id="name" required placeholder="Name of Category">
                        </div>
                        <div class="mt-4">
