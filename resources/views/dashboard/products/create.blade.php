...
<section class="max-w-screen-2xl mx-auto">
    ...
    <div class="mt-10 px-10">
        <form action="{{ url('/dashboard/products/create') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex justify-between">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="number" step="0.01" name="weight" id="weight" placeholder="Product Weight (e.g., 1.5kg)" required class="bg-gray-100 px-4 py-2 mt-2 rounded-md w-[450px]" oninput="calculatePrice()">
                </div>

                {{-- For price --}}
                <div class="flex flex-col">
                    <label for="price">Price ($)</label>
                    <input type="text" name="price" id="price" placeholder="Product Price" readonly required class="bg-gray-100 px-4 py-2 mt-2 rounded-md w-[450px]">
                </div>
            </div>
