        ...
        <div class="w-[580px] bg-slate-50 rounded-2xl p-10">
            <form class="w-full">
                ...
                <div class="mb-5">
                    ...
                    <input type="number" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                </div>
                <div class="mb-5">
