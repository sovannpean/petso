        ...
        <div class="w-[580px] bg-slate-50 rounded-2xl p-10">
            <form class="w-full">
                ...
                <div class="flex items-start mb-5">
                    ...
                    <label for="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree to the <a href="#" class="font-semibold text-[#526BEE]">terms of service</a> and <a href="#" class="font-semibold text-[#526BEE]">privacy policy</a></label>
                </div>
