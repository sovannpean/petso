            ...
            <div class="my-20">
                <div class="mb-5">
                    ...
                    <div class="flex justify-center gap-5 mt-5">
                        <a href="/food-dog" class="border border-[#48b194] px-5 py-1.5 rounded-full">
                ...
                <div class="grid grid-cols-4 gap-4 mt-10">
                    ...
                    <div class="border border-gray-200">
                        <div>
                            <a href="#">
                                <img src="{{asset('https://www.thinkjinx.com/cdn/shop/files/jerky-variety-pack-dog-treats-jinx-815570.jpg?v=1702617445&width=3000')}}" alt="" class="w-full h-[350px] object-cover">
                            </a>
                        </div>
                        <div class="bg-[#48b194]">
