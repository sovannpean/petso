            ...
            <div class="my-20">
                <div class="mb-5">
                    ...
                    <div class="flex justify-center gap-5 mt-5">
                        ...
                        <a href="#" class="bg-[#48b194] px-5 py-1.5 rounded-full">
                            <h1 class="text-white font-medium">Healthcare</h1>
                        </a>
                ...
                <div class="grid grid-cols-4 gap-4 mt-10">
                    ...
                    <div class="border border-gray-200">
                        <div>
                            <a href="#">
                                <img src="{{asset('https://www.petzo.net/wp-content/uploads/2022/01/mini-toothbrush-2.jpg')}}" alt="" class="w-full h-[350px] object-cover">
                            </a>
                        </div>
                        <div class="bg-[#48b194]">
